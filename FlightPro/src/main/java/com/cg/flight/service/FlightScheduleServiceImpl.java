...
public class FlightScheduleServiceImpl implements FlightScheduleService {
	...
	public String cancelFlightSchedule(String schFlightId) throws ScheduledIdNotFoundException {
		...
		if (!scheduleFlightopt.isPresent())
			...
			if(schedule.getScheduleStatus().equalsIgnoreCase(ScheduleConstants.FLIGHT_CANCELLED))
				throw new ScheduledIdNotFoundException(ScheduleConstants.ALREADY_CANCELLED);
